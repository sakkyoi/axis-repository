...
describe("AptPublisher", () => {
  it("copies pool objects and writes signed APT metadata", async () => {
    ...
    expect(result.objects).toEqual([
      ...
      {
        key: "repositories/debian-internal/dists/noble/main/binary-amd64/Packages.zst",
      ...
      {
        key: "repositories/debian-internal/dists/noble/main/i18n/Translation-en.zst",
        contentType: "application/zstd",
      },
      {
  ...
  it("writes every package index generated by APT metadata", async () => {
    ...
    expect(result.objects.map((object) => object.key)).toEqual([
      ...
      "repositories/debian-internal/dists/noble/main/binary-amd64/Packages.zst",
      ...
      "repositories/debian-internal/dists/noble/main/binary-arm64/Packages.zst",
      ...
      "repositories/debian-internal/dists/noble/contrib/binary-amd64/Packages.zst",
      ...
      "repositories/debian-internal/dists/noble/main/i18n/Translation-en.zst",
      ...
      "repositories/debian-internal/dists/noble/contrib/i18n/Translation-en.zst",
